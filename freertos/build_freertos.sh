...
# this script will not be called by sdk build script
...
# this .ld is generated by build script,
# only use for building test
cp $TOP_DIR/scripts/cvi_board_memmap_TEST_ONLY.ld $BUILD_PATH/task/cvi_board_memmap.ld
